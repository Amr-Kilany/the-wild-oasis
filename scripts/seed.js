...
// 3. BOOKINGS DATA
// Helper to calculate dates relative to "Today" (when script runs)
...
// Simple subtract function for duration calculation
const subtractDatesFunc = (dateStr1, dateStr2) =>
